...
Until a release is published on this repository, build from source or use a maintainer-built JAR from [GitHub releases](https://github.com/killbill/killbill-kintsugi-plugin/releases).
